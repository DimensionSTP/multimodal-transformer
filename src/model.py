...
class FeedForwardBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        forwarded = self.feed_forward2(self.dropout1(F.relu(self.feed_forward1(normalized))))
...
class EncoderBlock(nn.Module):
    def __init__(self, 
        ...
        self.feed_forward = FeedForwardBlock(d_model, d_feed_forward, res_dropout, relu_dropout)
...
class CrossModalTransformer(nn.Module):
    def __init__(self, 
        ...
        layer = EncoderBlock(d_model=d_model, 
                             n_heads=n_heads, 
    ...
    @staticmethod
    def get_clone(module: nn.Module, 
                  iteration: int) -> ModuleList:
...
class MultiModalTransformer(nn.Module):
    ...
    def get_network(**kwargs) -> nn.Module:
        return CrossModalTransformer(d_model=kwargs['d_model'], 
